...
class node {
 public:
  ...
  // Constructor to initialize node with given data and null next and prev
  // pointers
  node(T value) {
    data = value;
    next = nullptr;
...
class Doubly_circular_linked_list {
 ...
 public:
  ...
  ~Doubly_circular_linked_list() { clear(); }
  ...
  void insertAtHead(T element) {
    ...
    if (head == nullptr) {
      ...
      // If the list is not empty, make the new node point to the current head
      // and update the head's previous pointer
      newNode->next = head;
      newNode->prev = tail;
      head->prev = newNode;
      tail->next = newNode;
  ...
  void insertAtTail(T element) {
    ...
    if (tail == nullptr) {
      ...
      // If the list is not empty, make the current tail point to the new node
